...
%%Dion KH
%%Useage: loads data from .DAT of .FIL based on given time. It's based on
%%file-functions of matlab so it only opens and read and does not load, very
%%convinient for large data files.

%%INPUTS:
%%F_in=name of the .dat or .fil file 
...
%%OUTPUT:
%%DATA= a 3 dimnentional matrix [channel_number, data, T]
if rem(N_points,2)~=0
